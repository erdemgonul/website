      ...
      <div className="privacy-policy-container">
        <header className="privacy-policy-header">
          ...
          <p className="privacy-policy-intro">
            This privacy policy applies to the {policy.appName} app (hereby referred to as
            &quot;Application&quot;) for mobile devices that was created by {policy.author} (hereby
            referred to as &quot;Service Provider&quot;) as a {policy.type} service. This service is
        ...
        <main className="privacy-policy-content">
          <section>
            ...
            {policy.collectsLocation ? (
              <>
                <p>
                  The Application collects your device&apos;s location, which helps the Service
                  Provider determine your approximate geographical location and make use of in below
                  ways:
                </p>
                <ul>
                  <li>
                    <strong>Geolocation Services:</strong> The Service Provider utilizes location
                    data to provide features such as personalized content, relevant recommendations,
                    and location-based services.
                  </li>
                  <li>
                    <strong>Analytics and Improvements:</strong> Aggregated and anonymized location
                    data helps the Service Provider to analyze user behavior, identify trends, and
                    improve the overall performance and functionality of the Application.
                  </li>
                  <li>
                    <strong>Third-Party Services:</strong> Periodically, the Service Provider may
                    transmit anonymized location data to external services. These services assist
            ...
            <p>
              ...
              you to provide us with certain personally identifiable information. The information
              that the Service Provider request will be retained by them and used as described in
              this privacy policy.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              User Provided Data that you have provided via the Application, please contact them at{" "}
              <a href={`mailto:${policy.email}`}>{policy.email}</a> and they will respond in a
              reasonable time.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              us with personal information, please contact the Service Provider ({policy.email}) so
          ...
          <section>
            ...
            <p>This privacy policy is effective as of {policy.effectiveDate}.</p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              <a href={`mailto:${policy.email}`}>{policy.email}</a>.
            </p>
          </section>

          {policy.customSections &&
            policy.customSections.map((section, index) => (
              <section key={index}>
                <h2>{section.title}</h2>
                <p>{section.content}</p>
              </section>
        ...
        <footer className="privacy-policy-footer">
          <hr />
          <p>
            Contact: <a href={`mailto:${policy.email}`}>{policy.email}</a>
          </p>
        </footer>
      </div>
    </div>
